    ...
    pageEncoding="UTF-8"%>
		...
		<div class="banner_2">
			<div class="banner_2_background"
				style="background-image: url(${pageContext.request.contextPath}/webapp/static/resources/images/banner_2_background.jpg)"></div>
									...
									<div class="col-lg-8 col-md-6 fill_height">
										<div class="banner_2_image_container">
											<div class="banner_2_image">
												<img
													src="${pageContext.request.contextPath}/webapp/static/resources/images/banner_2_product.png"
													alt="">
											</div>
										</div>
									</div>

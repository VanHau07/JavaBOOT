...
public class CategorysManager {
	...
	public String index(Model model) {
		Categorys entity = new Categorys();
	...
	public String edit(Model model, @PathVariable("id") Integer id) {
		Categorys entity = dao.findById(id);
		model.addAttribute("entity", entity);
		model.addAttribute("list_cate", dao.findAll());
		return "admin/category/index";
	}
	
	@RequestMapping("/admin/category/create")
	public String create(RedirectAttributes model, @ModelAttribute("entity") Categorys entity) {
		dao.create(entity);
	...
	public String update(RedirectAttributes model, @ModelAttribute("entity") Categorys entity) {
		dao.update(entity);
